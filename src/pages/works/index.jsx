      ...
      <SidebarWrapper>
        ...
        <Row gutter={[20, 20]}>
          <Col xs={24} sm={24} md={12} lg={8}>
            <AboutTile
              img="demo.png"
              alt="Neural Machine Translators"
              textH4="Translation between Japanese(jpn) and Ainu Language(ain)"
              textH3="Neural Machine Translators"
              link="https://huggingface.co/Language-Media-Lab"
            />
          </Col>
          <Col xs={24} sm={24} md={12} lg={8}>
            <AboutTile
