...
var EnhancedLocaleTable = (0, _compose.default)((0, _withLocale.default)(['Table']), (0, _utils.defaultProps)({
  loadAnimation: true
}))(_rsuiteTable.Table);
(0, _setStatic.default)('Column', _rsuiteTable.Column)(EnhancedLocaleTable);
(0, _setStatic.default)('ColumnGroup', _rsuiteTable.ColumnGroup)(EnhancedLocaleTable);
