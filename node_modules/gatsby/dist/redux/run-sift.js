...
const runFilterAndSort = args => {
  ...
  const result = applyFilters(filter, firstOnly, nodeTypeNames, typedKeyValueIndexes, resolvedFields, stats);
...
const applyFilters = (filterFields, firstOnly, nodeTypeNames, typedKeyValueIndexes, resolvedFields, stats) => {
