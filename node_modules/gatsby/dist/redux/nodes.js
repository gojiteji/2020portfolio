...
exports.getNodesByTypedChain = exports.ensureIndexByTypedChain = exports.addResolvedNodes = exports.getResolvedNode = exports.saveResolvedNodes = exports.getNodeAndSavePathDependency = exports.hasNodeChanged = exports.getTypes = exports.getNodesByType = exports.getNode = exports.getNodes = void 0;
...
const addResolvedNodes = typeName => {
  const resolvedNodes = [];
...
const getNodesByTypedChain = (chain, value, nodeTypeNames, typedKeyValueIndexes) => {
  ...
  const byTypedKey = typedKeyValueIndexes === null || typedKeyValueIndexes === void 0 ? void 0 : typedKeyValueIndexes.get(typedKey);
